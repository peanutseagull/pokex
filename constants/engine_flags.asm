...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_VANIVILLE
	const ENGINE_FLYPOINT_AQUACORDE
	const ENGINE_FLYPOINT_SANTALUNE
	; const ENGINE_FLYPOINT_LUMIOSE
	; const ENGINE_FLYPOINT_CAMPHRIER
	; const ENGINE_FLYPOINT_CYLLAGE
	; const ENGINE_FLYPOINT_AMBRETTE
	; const ENGINE_FLYPOINT_GEOSENGE
	; const ENGINE_FLYPOINT_SHALOUR
	; const ENGINE_FLYPOINT_COUMARINE
	; const ENGINE_FLYPOINT_LAVERRE
	; const ENGINE_FLYPOINT_DENDEMILLE
	; const ENGINE_FLYPOINT_ANISTAR
	; const ENGINE_FLYPOINT_COURIWAY
	; const ENGINE_FLYPOINT_SNOWBELLE
	; const ENGINE_FLYPOINT_LEAGUE
	; const ENGINE_FLYPOINT_KILOUDE
...
; wDailyFlags1
	...
	const ENGINE_TRADED_DIVE_BALL_TODAY
; wDailyFlags2
