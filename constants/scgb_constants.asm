...
; GetPredefPal arguments (see engine/gfx/color.asm)
	...
	const PREDEFPAL_VANIVILLE
	const PREDEFPAL_AQUACORDE
	const PREDEFPAL_DUNGEONS
	const PREDEFPAL_SANTALUNE
	const PREDEFPAL_LUMIOSE
	const PREDEFPAL_CAMPHRIER
	const PREDEFPAL_PARFUMGARDEN
	const PREDEFPAL_CYLLAGE
	const PREDEFPAL_AMBRETTE
	const PREDEFPAL_GEOSENGE
	const PREDEFPAL_SHALOUR
	const PREDEFPAL_COUMARINE
	const PREDEFPAL_LAVERRE
	const PREDEFPAL_DENDEMILLE
	const PREDEFPAL_ANISTAR
	const PREDEFPAL_COURIWAY
	const PREDEFPAL_SNOWBELLE
	const PREDEFPAL_LEAGUE
	const PREDEFPAL_KILOUDE
