...
; Boarder
	const EVENT_BEAT_BOARDER_ROLAND
...
; Picnicker
	...
	const EVENT_BEAT_PICNICKER_BRIDGET
	const EVENT_BEAT_PICNICKER_LOUISE
...
; Beauty
	...
	; const EVENT_BEAT_BEAUTY_VALERIA
; Johto Gym Leaders
...
; Bug Catcher
	...
	const EVENT_BEAT_BUG_CATCHER_OLIVER
...
; Officer
	const EVENT_BEAT_OFFICER_WHEATON
	const EVENT_BEAT_OFFICER_FABIAN
	const EVENT_BEAT_OFFICER_GROVER
...
; Youngster
	...
	const EVENT_BEAT_YOUNGSTER_LOIC
