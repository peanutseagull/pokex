...
; Johto Gym Leader TM gifts
	...
	const EVENT_GOT_TM39_ROCK_THROW ; ROCK_TOMB
...
; Johto story events
	...
	const EVENT_CHOSE_CHESPIN
	const EVENT_CHOSE_FENNEKIN
	const EVENT_CHOSE_FROAKIE
	const EVENT_GOT_EXP_SHARE
	const EVENT_MET_SYCAMORE
	const EVENT_BLACKOUT_OVER_1
	const EVENT_BLACKOUT_OVER_2
	const EVENT_HAVENT_PAID_PARFUM_ENTRANCE_FEE
	const EVENT_PAID_PARFUM_ENTRANCE_FEE
	const EVENT_GOT_TM46_THIEF
	const EVENT_GOT_POKE_FLUTE
	const EVENT_CONNECTING_CAVE_HEALED_YOU
	const EVENT_MET_FOSSIL_SCIENTIST
	const EVENT_FOUND_ASSISTANT
	const EVENT_IS_RHYHORN
	const EVENT_ROUTE_9_HEALED_YOU
	const EVENT_GLITTERING_CAVE_DEEP_SAID_NO
	const EVENT_CHOSE_JAW_FOSSIL
	const EVENT_CHOSE_SAIL_FOSSIL
	const EVENT_GAVE_SCIENTIST_JAW_FOSSIL
	const EVENT_GAVE_SCIENTIST_SAIL_FOSSIL
	const EVENT_GAVE_SCIENTIST_OLD_AMBER
	const EVENT_CHOSE_GREEN_BICYCLE
	const EVENT_CHOSE_YELLOW_BICYCLE
...
; Johto hidden items
	const EVENT_SANTALUNE_FOREST_HIDDEN_GREAT_BALL
	const EVENT_SANTALUNE_FOREST_HIDDEN_SUPER_POTION
	const EVENT_ROUTE_5_HIDDEN_PARLYZ_HEAL
	const EVENT_CAMPHRIER_TOWN_HIDDEN_ETHER
	const EVENT_CAMPHRIER_TOWN_HIDDEN_ANTIDOTE
	const EVENT_ROUTE_6_HIDDEN_ANTIDOTE
	const EVENT_ROUTE_6_HIDDEN_TINY_MUSHROOM
	const EVENT_PARFUM_PALACE_GARDEN_2_HIDDEN_X_SPECIAL
	const EVENT_PARFUM_PALACE_GARDEN_4_HIDDEN_RARE_CANDY
	const EVENT_PARFUM_PALACE_GARDEN_6_HIDDEN_SILVER_LEAF
	const EVENT_ROUTE_8_UPPER_HIDDEN_SUPER_POTION
	const EVENT_ROUTE_8_UPPER_HIDDEN_ESCAPE_ROPE
	const EVENT_AMBRETTE_TOWN_HIDDEN_X_ATTACK
	const EVENT_AMBRETTE_TOWN_HIDDEN_RARE_CANDY
	const EVENT_ROUTE_8_LOWER_HIDDEN_ULTRA_BALL
	const EVENT_ROUTE_8_LOWER_HIDDEN_STARDUST
	const EVENT_ROUTE_8_LOWER_HIDDEN_PEARL
	const EVENT_ROUTE_8_LOWER_HIDDEN_HEART_SCALE
	const EVENT_ROUTE_9_HIDDEN_SUPER_REPEL
	const EVENT_CYLLAGE_CITY_HIDDEN_ETHER
	const EVENT_CYLLAGE_CITY_HIDDEN_X_SPEED
	const EVENT_CYLLAGE_CITY_HIDDEN_PROTEIN
	const EVENT_CYLLAGE_CITY_HIDDEN_PEARL
	const EVENT_ROUTE_10_HIDDEN_REVIVE
	const EVENT_ROUTE_10_HIDDEN_PARLYZ_HEAL
	const EVENT_ROUTE_10_HIDDEN_BURN_HEAL
	const EVENT_ROUTE_11_HIDDEN_THUNDERSTONE
	const EVENT_ROUTE_11_HIDDEN_SUPER_POTION
	const EVENT_SHALOUR_CITY_HIDDEN_X_SPECIAL
...
; Trainer flags
; Kalos Gym Leaders
	const EVENT_BEAT_VIOLA
	const EVENT_BEAT_GRANT
	const EVENT_BEAT_KORRINA
	const EVENT_BEAT_RAMOS
	const EVENT_BEAT_CLEMONT
	const EVENT_BEAT_VALERIE
	const EVENT_BEAT_OLYMPIA
	const EVENT_BEAT_WULFRIC
; Elite Four and Champion
	const EVENT_BEAT_ELITE_4_WIKSTROM
	const EVENT_BEAT_ELITE_4_SIEBOLD
	const EVENT_BEAT_ELITE_4_MALVA
	const EVENT_BEAT_ELITE_4_DRASNA
	const EVENT_BEAT_CHAMPION_DIANTHA
; Bug Catcher
...
; Youngster
	...
	const EVENT_BEAT_YOUNGSTER_ZACHARY
	const EVENT_BEAT_YOUNGSTER_KEITA
	const EVENT_BEAT_YOUNGSTER_ANTHONY
	const EVENT_BEAT_YOUNGSTER_TYLER
	const EVENT_BEAT_YOUNGSTER_JACOB
; Lass
	const EVENT_BEAT_LASS_ANNA
	const EVENT_BEAT_LASS_LISE
	const EVENT_BEAT_LASS_CHARLOTTE
	const EVENT_BEAT_LASS_ELIN
	const EVENT_BEAT_LASS_ELSA
; Picnicker
	const EVENT_BEAT_PICNICKER_ELLA
	const EVENT_BEAT_PICNICKER_MIA
; Camper
	const EVENT_BEAT_CAMPER_OLIVER
	const EVENT_BEAT_CAMPER_ADRIAN
; Schoolboy
	const EVENT_BEAT_SCHOOLBOY_BRIGHTON
	const EVENT_BEAT_SCHOOLBOY_RABBIE	
; Schoolgirl
	const EVENT_BEAT_SCHOOLGIRL_BRIDGET
; Risingstarm
	const EVENT_BEAT_RISING_STAR_LOIC
	const EVENT_BEAT_RISING_STAR_TYSON
	const EVENT_BEAT_RISING_STAR_HAMISH	
	const EVENT_BEAT_RISING_STAR_RHYS
	const EVENT_BEAT_RISING_STAR_DIDIER
; Risingstarf
	const EVENT_BEAT_RISING_STAR_LOUISE
	const EVENT_BEAT_RISING_STAR_PAULA
	const EVENT_BEAT_RISING_STAR_MANON
; Twins
	const EVENT_BEAT_TWINS_MAY_AND_JOY	
; Skaterm
	const EVENT_BEAT_SKATER_ROLAND
	const EVENT_BEAT_SKATER_FLORIN
; Skaterf
	const EVENT_BEAT_SKATER_CALIDA
	const EVENT_BEAT_SKATER_WINNIE
; Hiker
	const EVENT_BEAT_HIKER_CRAIG
	const EVENT_BEAT_HIKER_BERNARD
	const EVENT_BEAT_HIKER_DUNSTAN
; Backpacker
	const EVENT_BEAT_BACKPACKER_HEIKE
	const EVENT_BEAT_BACKPACKER_RODERICK
	const EVENT_BEAT_BACKPACKER_JEROME
	const EVENT_BEAT_BACKPACKER_LANE
; Gardener
	const EVENT_BEAT_GARDENER_WHEATON
	const EVENT_BEAT_GARDENER_FABIAN
	const EVENT_BEAT_GARDENER_GROVER
; PokefanM
	const EVENT_BEAT_POKEFANM_GABE
; PokefanF
	const EVENT_BEAT_POKEFANF_AGNES
; Pokefanfamily
	const EVENT_BEAT_POKEFAN_FAMILY_JAN_ERIN
; Richboy
; Lady
; Fairygirl
; Hexmaniac
; Mystery Sisters
; PsychicT
	const EVENT_BEAT_PSYCHIC_ROBERT
	const EVENT_BEAT_PSYCHIC_SAYID
	const EVENT_BEAT_PSYCHIC_EMANUEL
	const EVENT_BEAT_PSYCHIC_FRANZ
; BlackbeltT
	const EVENT_BEAT_BLACK_BELT_CADOC
	const EVENT_BEAT_BLACK_BELT_IGOR
; Brains and Brawn
	const EVENT_BEAT_BRAINS_BRAWN_FRANK_SLY 
; Battlegirl
	const EVENT_BEAT_BATTLE_GIRL_GERARDINE
	const EVENT_BEAT_BATTLE_GIRL_HEDVIG
; CooltrainerM
	const EVENT_BEAT_COOLTRAINER_EMIL
; CooltrainerF
	const EVENT_BEAT_COOLTRAINER_MONIQUE
; Cool Duo
; Garcon
; Waitress
; Chef
...
; Owner
; Gruntm
	const EVENT_BEAT_GRUNTM_1 ; unused
	const EVENT_BEAT_GRUNTM_2 ; unused
	const EVENT_BEAT_GRUNTM_3 ; unused
; Gruntf
	const EVENT_BEAT_GRUNTF_1
	const EVENT_BEAT_GRUNTF_2 ; unused
	const EVENT_BEAT_GRUNTF_3
	const EVENT_BEAT_GRUNTF_4
; Adminm
; Adminf
; Beauty
	const EVENT_BEAT_BEAUTY_BRIGITTE
; Pokemaniac
; Touristm
	const EVENT_BEAT_TOURIST_TAKEMI
	const EVENT_BEAT_TOURIST_HARUTO
; Touristf
	const EVENT_BEAT_TOURIST_MARI
	const EVENT_BEAT_TOURIST_MONAMI
; Tourist Lady
	const EVENT_BEAT_TOURIST_HIROKO
	const EVENT_BEAT_TOURIST_ERIKO
	const EVENT_BEAT_TOURIST_FUMIKO
	const EVENT_BEAT_TOURIST_TOMOKO
; Honeymooners
	const EVENT_BEAT_HONEYMOONERS_YUU_AMI
; Artistm
	const EVENT_BEAT_ARTIST_PIERRE
; Artistf
	const EVENT_BEAT_ARTIST_GEORGIA
; Artist Family
	const EVENT_BEAT_ARTIST_FAMILY_MONA_PAOLO
; Breederm
; Breederf
	const EVENT_BEAT_BREEDER_MERCY
; Skytrainerm
	const EVENT_BEAT_SKY_TRAINER_HOWE
	const EVENT_BEAT_SKY_TRAINER_COLM
	const EVENT_BEAT_SKY_TRAINER_ORION
; Skytrainerf
	const EVENT_BEAT_SKY_TRAINER_AVEZA
	const EVENT_BEAT_SKY_TRAINER_YVETTE
; Fisher
	const EVENT_BEAT_FISHER_WHARTON
	const EVENT_BEAT_FISHER_SHAD
; Swimmerm
	const EVENT_BEAT_SWIMMER_ESTABAN
	const EVENT_BEAT_SWIMMER_RAMSES
; Swimmerf
	const EVENT_BEAT_SWIMMER_GENEVIEVE
	const EVENT_BEAT_SWIMMER_MARISSA
; Rangerm
; Rangerf
; Rangers
; Monsieur
...
; Johto itemballs
	const EVENT_SANTALUNE_FOREST_POTION
	const EVENT_SANTALUNE_FOREST_POKE_BALL
	const EVENT_SANTALUNE_FOREST_ANTIDOTE
	const EVENT_SANTALUNE_FOREST_PARLYZ_HEAL
	const EVENT_ROUTE_3_SUPER_POTION
	const EVENT_ROUTE_3_SHINY_STONE
	const EVENT_ROUTE_3_REVIVE
	const EVENT_ROUTE_4_REPEL
	const EVENT_ROUTE_4_SUPER_POTION
	const EVENT_ROUTE_4_GREAT_BALL
	const EVENT_ROUTE_4_ANTIDOTE
	const EVENT_ROUTE_4_POISON_BARB
	const EVENT_ROUTE_4_ETHER
	const EVENT_ROUTE_22_ELIXER
	const EVENT_ROUTE_5_SUPER_POTION1
	const EVENT_ROUTE_5_SUPER_POTION2
	const EVENT_ROUTE_5_GREAT_BALL
	const EVENT_ROUTE_5_X_ATTACK
	const EVENT_ROUTE_5_SHARP_BEAK
	const EVENT_CAMPHRIER_TOWN_STAR_PIECE
	const EVENT_CAMPHRIER_TOWN_X_ATTACK
	const EVENT_PARFUM_PALACE_OUTSIDE_ETHER
	const EVENT_ROUTE_6_SUPER_REPEL
	const EVENT_ROUTE_6_ANTIDOTE
	const EVENT_ROUTE_6_AWAKENING
	const EVENT_ROUTE_6_X_SPECIAL
	const EVENT_ROUTE_6_ULTRA_BALL
	const EVENT_GOT_TM09_PSYCH_UP ; VENOSHOCK
	const EVENT_ROUTE_6_X_SPEED
	const EVENT_GOT_AMULET_COIN
	const EVENT_PARFUM_PALACE_GARDEN_3_ANTIDOTE
	const EVENT_PARFUM_PALACE_GARDEN_4_SUPER_POTION
	const EVENT_PARFUM_PALACE_GARDEN_6_REVIVE
	const EVENT_PARFUM_PALACE_GARDEN_7_GUARD_SPEC
	const EVENT_ROUTE_7_PP_UP
	const EVENT_ROUTE_7_X_SPECIAL
	const EVENT_ROUTE_7_FRIEND_BALL ; HEAL_BALL
	const EVENT_ROUTE_7_TINY_MUSHROOM
	const EVENT_ROUTE_7_SILVERPOWDER
	const EVENT_ROUTE_8_UPPER_HP_UP
	const EVENT_ROUTE_8_UPPER_LEAF_STONE
	const EVENT_ROUTE_8_UPPER_WATER_STONE
	const EVENT_AMBRETTE_TOWN_PEARL
	const EVENT_ROUTE_8_LOWER_HEART_SCALE
	const EVENT_ROUTE_9_X_DEFEND
	const EVENT_ROUTE_9_PARLYZ_HEAL
	const EVENT_ROUTE_9_FIRE_STONE
	const EVENT_ROUTE_9_DUSK_BALL
	const EVENT_GLITTERING_CAVE_ENTRANCE_HARD_STONE
	; const EVENT_GOT_TM65_SHADOW_CLAW
	const EVENT_GLITTERING_CAVE_DEEP_ESCAPE_ROPE
	const EVENT_GOT_TM40_WING_ATTACK ; AERIAL_ACE
	const EVENT_CYLLAGE_CITY_X_SPECIAL
	const EVENT_CYLLAGE_CITY_X_DEFEND
	const EVENT_CYLLAGE_CITY_SUPER_POTION
	; const EVENT_GOT_TM73_THUNDER_WAVE
	const EVENT_ROUTE_10_THUNDERSTONE
	const EVENT_ROUTE_10_X_ACCURACY
	; const EVENT_ROUTE_10_MIND_PLATE
	const EVENT_GEOSENGE_TOWN_SOFT_SAND
	; const EVENT_GEOSENGE_TOWN_TIMER_BALL
	const EVENT_ROUTE_11_HYPER_POTION
	; const EVENT_GOT_TM69_ROCK_POLISH
	const EVENT_REFLECTION_CAVE_1F_NEST_BALL
	const EVENT_REFLECTION_CAVE_1F_REVIVE
	const EVENT_REFLECTION_CAVE_1F_MOON_STONE
	const EVENT_REFLECTION_CAVE_B1F_BLACK_BELT
	const EVENT_REFLECTION_CAVE_B1F_ESCAPE_ROPE
	const EVENT_REFLECTION_CAVE_B1F_HYPER_POTION
	const EVENT_REFLECTION_CAVE_B1F_IRON
	; const EVENT_REFLECTION_CAVE_B2F_EARTH_PLATE
	; const EVENT_GOT_TM74_GYRO_BALL
; Johto people
	...
	const EVENT_VANIVILLE_TOWN_RIVALS
	const EVENT_ROUTE_1_SHAUNA
	const EVENT_ROUTE_22_SERENA
	const EVENT_DEXIO_GATE
	const EVENT_SINA_GATE
	const EVENT_RIVALS_IN_SYCAMORE_LAB
	const EVENT_LYSANDRE_IN_SYCAMORE_LAB
	const EVENT_SERENA_SYCAMORE_LAB
	const EVENT_CAFE_SOLEIL_LYSANDRE
	const EVENT_TREVOR_LUMIOSE_SOUTH
	const EVENT_RESTAURANT_LE_NAH_WAITER
	const EVENT_MR_BONDING_ROUTE_5_LUMIOSE_GATE
	const EVENT_ROUTE_5_EAST_KORRINA
	const EVENT_TIERNO_ROUTE_5
	const EVENT_MR_BONDING_CAMPHRIER
	const EVENT_SHABBONEAU_CASTLE_SHAUNA
	const EVENT_SHABBONEAU_CASTLE_GUY
	const EVENT_SHABBONEAU_CASTLE_BLACK_BELT
	const EVENT_ROUTE_7_SNORLAX
	const EVENT_ROUTE_7_BLACK_BELT
	const EVENT_ROUTE_7_YOUNGSTER
	const EVENT_ROUTE_7_SHAUNA
	const EVENT_BERRY_FIELDS_MAN
	const EVENT_BERRY_FIELDS_GIRL
	const EVENT_PARFUM_PALACE_1F_SHAUNA
	const EVENT_PARFUM_PALACE_1F_MAN
	const EVENT_PARFUM_PALACE_GARDEN_MAZE_FURFROU
	const EVENT_PARFUM_PALACE_GARDEN_MAZE_SHAUNA
	const EVENT_PARFUM_PALACE_GARDEN_MAZE_MAN
	const EVENT_PARFUM_PALACE_2F_BALCONY_SHAUNA
	const EVENT_PARFUM_PALACE_2F_BALCONY_MAN
	const EVENT_PARFUM_PALACE_2F_BALCONY_BUTLER
	const EVENT_ROUTE_7_MAN
	const EVENT_ROUTE_7_FURFROU
	const EVENT_MR_BONDING_AMBRETTE
	const EVENT_ASSISTANT_IN_FOSSIL_LAB
	const EVENT_GLITTERING_CAVE_DEEP_FLARES
	const EVENT_GLITTERING_CAVE_DEEP_FLARES2
	const EVENT_MR_BONDING_CYLLAGE
	const EVENT_CYLLAGE_CITY_GRANT
	const EVENT_ROUTE_10_FLARES
	const EVENT_GEOSENGE_TOWN_FLARE1
	const EVENT_GEOSENGE_TOWN_FLARE2
	const EVENT_GEOSENGE_TOWN_SERENA
	const EVENT_GEOSENGE_TOWN_GUIDE
	const EVENT_GEOSENGE_TOWN_KORRINA
	const EVENT_GEOSENGE_TOWN_IN_THE_WAY
	const EVENT_MR_BONDING_GEOSENGE
	const EVENT_HOTEL_MARINE_SNOW_GUIDE
	const EVENT_REFLECTION_CAVE_B1F_TIERNO
	const EVENT_MR_BONDING_SHALOUR
	...
	const EVENT_DAY_CARE_MAN_ON_ROUTE_7
...
; New to Crystal
	...
	const EVENT_SANTALUNE_CITY_GREAT_BALL
	const EVENT_SYCAMORE_LAB_FRIEND_BALLS
	const EVENT_GOT_QUICK_CLAW
	const EVENT_GOT_LUMIOSE_OFFICE_QUICK_BALLS
	const EVENT_CAMPHRIER_TOWN_ULTRA_BALL
	const EVENT_CAMPHRIER_TOWN_BERRY_JUICE
	const EVENT_CAMPHRIER_TOWN_MOOMOO_MILK
	const EVENT_CAMPHERIER_TOWN_FULL_HEAL
	const EVENT_SHABBONEAU_CASTLE_ESCAPE_ROPE
	const EVENT_PARFUM_PALACE_OUTSIDE_BERRY
	const EVENT_GOT_LENS_CASE
	const EVENT_GOT_ROCK_SMASH
	const EVENT_RECEIVED_ROCKY_HELMET
	const EVENT_GOT_AERODACTYLITE
	const EVENT_GOT_ITEMFINDER
	const EVENT_GOT_TM21_FRUSTRATION
	const EVENT_CYLLAGE_CITY_WHIPPED_DREAM
	const EVENT_CYLLAGE_CITY_BERRIES
	; const EVENT_GOT_TM88_SLEEP_TALK
	const EVENT_GOT_TM44_REST
	const EVENT_GOT_DESTINY_KNOT
	; const EVENT_GOT_TM66_PAYBACK
	const EVENT_GEOSENGE_TOWN_EVERSTONE
	const EVENT_GOT_SOOTHE_BELL
	const EVENT_SHALOUR_CITY_STARDUSTS
	const EVENT_GOT_EVIOLITE
	const EVENT_SHALOUR_CITY_LEPPA_BERRY
