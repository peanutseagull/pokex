...
.JohtoStarters: db BUENA_MON,    10, CHESPIN, FENNEKIN, FROAKIE
...
.Pokemon1:      db BUENA_MON,    10, PIKACHU, MEWTWO, GEODUDE
.Pokemon2:      db BUENA_MON,    10, HOOTHOOT, SPINARAK, MEWTWO
