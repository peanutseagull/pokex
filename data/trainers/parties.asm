...
BrockGroup:
	...
	; db 42, AERODACTYL,    BITE, SURF, PROTECT, SPIKE_CANNON
	db 44, ONIX,       BIND, ROCK_SLIDE, BIDE, SANDSTORM
	; db 42, AERODACTYL,   SLASH, SURF, ENDURE, GIGA_DRAIN
	db -1 ; end
...
LtSurgeGroup:
	...
	db 40, ELECTRODE,  SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
	; db 46, RAICHU, QUICK_ATTACK, THUNDERPUNCH, LIGHT_SCREEN, THUNDER
	db -1 ; end
...
SchoolboyGroup:
	...
	; db 35, VULPIX,  SUNNY_DAY, LEER, TAKE_DOWN, FLAME_WHEEL
...
JanineGroup:
	...
	; db 36, ARBOK,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	; db 36, ARBOK,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 33, ARIADOS,    SCARY_FACE, GIGA_DRAIN, STRING_SHOT, NIGHT_SHADE
	; db 39, ARBOK,   FORESIGHT, DOUBLE_TEAM, GUST, PSYCHIC_M
	db -1 ; end
...
CooltrainerMGroup:
	...
	; db 27, RAICHU, THUNDERPUNCH, LIGHT_SCREEN, SWIFT, SCREECH
	db -1 ; end
...
BeautyGroup:
	...
	db 16, SENTRET,     SCRATCH, GROWL, BITE, PAY_DAY
	db 16, SENTRET,     SCRATCH, GROWL, BITE, SLASH
	db -1 ; end
...
PokemaniacGroup:
	...
	db 12, TAUROS,  LICK, SUPERSONIC, CUT, NO_MOVE
	db -1 ; end
	...
	; POKEMANIAC (14)
	db "BRENT@", TRAINERTYPE_MOVES
	db 41, TAUROS,    ROLLOUT, ATTRACT, EGG_BOMB, SOFTBOILED
	db -1 ; end
...
SailorGroup:
	...
	db 18, SHELLDER,     BUBBLE, LEER, VICEGRIP, HARDEN
	db 20, SHELLDER,     BUBBLEBEAM, LEER, VICEGRIP, HARDEN
	db -1 ; end
...
BlaineGroup:
	...
	db 45, NINETALES,     THUNDERPUNCH, FIRE_PUNCH, SUNNY_DAY, CONFUSE_RAY
...
BurglarGroup:
	...
	db 26, VULPIX,  ROAR, EMBER, LEER, TAKE_DOWN
	db 24, EKANS,    TACKLE, SMOG, SLUDGE, SMOKESCREEN
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, MACHOKE,  DOUBLE_KICK, MEDITATE, JUMP_KICK, FOCUS_ENERGY
	db -1 ; end
	...
	db 36, MACHOKE,  DOUBLE_TEAM, HI_JUMP_KICK, MUD_SLAP, SWIFT
	db -1 ; end

	; BLACKBELT_T (4)
	db "LAO@", TRAINERTYPE_MOVES
	db 27, MACHOKE, COMET_PUNCH, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 33, EKANS,    TACKLE, SLUDGE, SMOKESCREEN, HAZE
	...
	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 30, EKANS,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 30, EKANS,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 30, EKANS,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 32, ARBOK,    TACKLE, EXPLOSION, SLUDGE, SMOKESCREEN
	db 30, EKANS,    TACKLE, SELFDESTRUCT, SLUDGE, SMOKESCREEN
	db 30, EKANS,    TACKLE, SMOG, SLUDGE, SMOKESCREEN
	db -1 ; end
...
PsychicGroup:
	...
	db 24, ABRA,       LEER, NIGHT_SHADE, FUTURE_SIGHT, CONFUSE_RAY
...
PicnickerGroup:
	...
	db 36, VULPIX,     DOUBLE_TEAM, STOMP, FIRE_SPIN, SUNNY_DAY
...
BlueGroup:
	...
	db 58, NINETALES,   ROAR, SWIFT, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
...
MysticalmanGroup:
	...
	db 23, KADABRA,    DREAM_EATER, HYPNOSIS, DISABLE, CONFUSION
