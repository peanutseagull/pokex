...
MapGroup_Vaniville:
	...
	map Route1, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_1, MUSIC_ROUTE_1, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Aquacorde:
	...
	map Route2, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
