...
;	dw MapGroup_NewBark
	dw MapGroup_Vaniville   ; 24
	dw MapGroup_Saffron     ; 25
;	dw MapGroup_Cherrygrove
	dw MapGroup_Aquacorde   ; 26
...
;	map ElmsLab, TILESET_LAB, INDOOR, LANDMARK_VANIVILLE_TOWN, MUSIC_PROF_ELM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
