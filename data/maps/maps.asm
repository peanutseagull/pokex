...
; pointers to the first map of each map group
	...
	dw MapGroup_Cyllage		;  8
	dw MapGroup_Ambrette	;  9
...
MapGroup_Lumiose:
	...
	map Route5LumioseGate, TILESET_GATE, INDOOR, LANDMARK_LUMIOSE_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
