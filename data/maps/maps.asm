...
MapGroup_Dungeons:
	...
	map ConnectingCave, TILESET_CAVE, CAVE, LANDMARK_CONNECTING_CAVE, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map GlitteringCaveEntrance, TILESET_DARK_CAVE, CAVE, LANDMARK_GLITTERING_CAVE, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map GlitteringCaveDeep, TILESET_DARK_CAVE, CAVE, LANDMARK_GLITTERING_CAVE, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Santalune:
	...
	map SantaluneBoutique, TILESET_MART , INDOOR, LANDMARK_SANTALUNE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lumiose:
	...
	map LumioseSouthwest, TILESET_JOHTO_MODERN, TOWN, LANDMARK_LUMIOSE_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LumioseSoutheast, TILESET_JOHTO_MODERN, TOWN, LANDMARK_LUMIOSE_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map SycamoreLab2F, TILESET_FACILITY, INDOOR, LANDMARK_LUMIOSE_CITY, MUSIC_PROF_ELM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SycamoreLab3F, TILESET_FACILITY, INDOOR, LANDMARK_LUMIOSE_CITY, MUSIC_PROF_ELM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CoiffureClips, TILESET_GAME_CORNER, INDOOR, LANDMARK_LUMIOSE_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	; map RestaurantLeNah, TILESET_
	map TrainerPrStudio, TILESET_GAME_CORNER, INDOOR, LANDMARK_LUMIOSE_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5LumioseGate, TILESET_GATE, GATE, LANDMARK_LUMIOSE_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LumioseNorthwest, TILESET_JOHTO_MODERN, TOWN, LANDMARK_LUMIOSE_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LumioseNortheast, TILESET_JOHTO_MODERN, TOWN, LANDMARK_LUMIOSE_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map StoneEmporium, TILESET_MART, INDOOR, LANDMARK_VERNAL_AVENUE, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Herboriste, TILESET_MART, INDOOR, LANDMARK_VERNAL_AVENUE, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FriseurFurfrou, TILESET_GAME_CORNER, INDOOR, LANDMARK_VERNAL_AVENUE, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CafeWoof, TILESET_GAME_CORNER, INDOOR, LANDMARK_VERNAL_AVENUE, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CafeClasse, TILESET_GAME_CORNER, INDOOR, LANDMARK_VERNAL_AVENUE, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BoutiqueCouture, TILESET_RADIO_TOWER, INDOOR, LANDMARK_VERNAL_AVENUE, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Camphrier:
	...
	map Route5East, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_5, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route5West, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_5, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CamphrierTown, TILESET_JOHTO, TOWN, LANDMARK_CAMPHRIER_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CamphrierPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CamphrierMart, TILESET_MART, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CamphrierHouse1, TILESET_HOUSE, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CamphrierHouse2, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map HotelCamphrier1F, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map HotelCamphrier2F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ShabboneauCastle, TILESET_TOWER, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ShabboneauCastle2F, TILESET_TOWER, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ShabboneauCastleBedroom, TILESET_TOWER, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route6, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_6, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map BerryFields, TILESET_JOHTO, ROUTE, LANDMARK_BERRY_FIELDS, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map BerryFieldsHouse, TILESET_HOUSE, INDOOR, LANDMARK_BERRY_FIELDS, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route7East, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_7, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route7West, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_7, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map DayCare, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_7, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ParfumPalaceOutside, TILESET_JOHTO, ROUTE, LANDMARK_ROUTE_6, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ParfumPalace1F, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ParfumPalace2F, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ParfumPalace1FRoom1, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ParfumPalace1FRoom2, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ParfumPalace1FRoom3, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ParfumPalace1FRoom4, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE	
	map ParfumPalace2FRoom1, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ParfumPalace2FRoom2, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ParfumPalace2FRoom3, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ParfumPalace2FRoom4, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ParfumPalace2FBalcony, TILESET_JOHTO, ROUTE, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE	
	assert_table_length NUM_CAMPHRIER_MAPS
	
MapGroup_ParfumGarden:
	table_width MAP_LENGTH, MapGroup_ParfumGarden
	map ParfumPalaceGarden1, TILESET_JOHTO, ROUTE, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ParfumPalaceGarden2, TILESET_JOHTO, ROUTE, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ParfumPalaceGarden3, TILESET_JOHTO, ROUTE, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ParfumPalaceGarden4, TILESET_JOHTO, ROUTE, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ParfumPalaceGarden5, TILESET_JOHTO, ROUTE, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ParfumPalaceGarden6, TILESET_JOHTO, ROUTE, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ParfumPalaceGarden7, TILESET_JOHTO, ROUTE, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE	
	map ParfumPalaceGardenMaze, TILESET_JOHTO, ROUTE, LANDMARK_PARFUM_PALACE, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	assert_table_length NUM_PARFUMGARDEN_MAPS
	
MapGroup_Ambrette:
	table_width MAP_LENGTH, MapGroup_Ambrette
	map Route8Upper, TILESET_KALOS_COASTAL, ROUTE, LANDMARK_ROUTE_8, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map AmbretteTown, TILESET_KALOS_COASTAL, TOWN, LANDMARK_AMBRETTE_TOWN, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map AmbrettePokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_AMBRETTE_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AmbretteMart, TILESET_MART, INDOOR, LANDMARK_AMBRETTE_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AmbretteHouse, TILESET_HOUSE, INDOOR, LANDMARK_AMBRETTE_TOWN, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map HotelAmbrette1F, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_AMBRETTE_TOWN, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map HotelAmbrette2F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_AMBRETTE_TOWN, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FossilLab, TILESET_FACILITY, INDOOR, LANDMARK_AMBRETTE_TOWN, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AmbretteAquarium, TILESET_FACILITY , INDOOR, LANDMARK_AMBRETTE_TOWN, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route9Gate, TILESET_GATE, GATE, LANDMARK_AMBRETTE_TOWN, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route9, TILESET_KALOS_COASTAL, ROUTE, LANDMARK_ROUTE_9, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	assert_table_length NUM_AMBRETTE_MAPS
	
MapGroup_Cyllage:
	table_width MAP_LENGTH, MapGroup_Cyllage
	map Route8Lower, TILESET_KALOS_COASTAL, ROUTE, LANDMARK_ROUTE_8, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
