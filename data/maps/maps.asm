...
MapGroup_Camphrier:
	...
	map CamphrierPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CamphrierMart, TILESET_MART, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CamphrierHouse1, TILESET_HOUSE, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CamphrierHouse2, TILESET_HOUSE, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map HotelCamphrier1F, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map HotelCamphrier2F, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map ShabboneauCastle, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_CAMPHRIER_TOWN, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
