...
LaverreCity_Blocks:
	INCBIN "maps/LaverreCity.blk"
	
DendemilleTown_Blocks:
	INCBIN "maps/DendemilleTown.blk"
	
AnistarCity_Blocks:
	INCBIN "maps/AnistarCity.blk"
	
CouriwayTown_Blocks:
	INCBIN "maps/CouriwayTown.blk"
	
SnowbelleCity_Blocks:
	INCBIN "maps/SnowbelleCity.blk"
	
PokemonLeague_Blocks:
	INCBIN "maps/PokemonLeague.blk"
	
KiloudeCity_Blocks:
	INCBIN "maps/KiloudeCity.blk"
