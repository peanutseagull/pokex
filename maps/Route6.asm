...
Route6Tm09:
	itemball TM_PSYCH_UP ; VENOSHOCK
...
Route6_MapEvents:
	...
	object_event 40, 34, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route6Tm09, EVENT_GOT_TM09_PSYCH_UP
