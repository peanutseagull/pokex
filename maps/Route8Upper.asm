...
Route8Upper_MapEvents:
	...
	object_event 27, 58, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 0, TrainerSkyTrainerHowe, -1
	...
	object_event 24, 60, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route8UpperLeafStone, EVENT_ROUTE_8_UPPER_LEAF_STONE
