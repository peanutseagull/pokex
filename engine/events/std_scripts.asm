...
InitializeEventsScript:
	...
	setevent EVENT_HAVENT_PAID_PARFUM_ENTRANCE_FEE
	setevent EVENT_PARFUM_PALACE_GARDEN_MAZE_SHAUNA
	setevent EVENT_PARFUM_PALACE_GARDEN_MAZE_MAN
	setevent EVENT_PARFUM_PALACE_2F_BALCONY_SHAUNA
	setevent EVENT_PARFUM_PALACE_2F_BALCONY_MAN
	setevent EVENT_PARFUM_PALACE_2F_BALCONY_BUTLER
	setevent EVENT_ROUTE_7_MAN
	setevent EVENT_ROUTE_7_FURFROU
	setevent EVENT_SHABBONEAU_CASTLE_BLACK_BELT
	setevent EVENT_ASSISTANT_IN_FOSSIL_LAB
	...
	setevent EVENT_HOTEL_MARINE_SNOW_GUIDE
